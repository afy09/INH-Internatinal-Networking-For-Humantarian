    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
          <div className="relative overflow-y-auto p-6 bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-slate-800">
            <div className="">
              <h3 className="mb-4 md:text-3xl text-2xl font-semibold">Daftar Video</h3>
